            ...
            <div>
              ...
              <div onClick={() => fileInputRef.current?.click()}
                ...
                className={cn(
                  ...
                  dragOver ? "border-amber-500/60 bg-amber-500/5" : file ? "border-amber-500/40 bg-amber-500/5" : "border-[#d0c6e0] hover:border-[#5b21b6]/50"
                )}>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              ...
              <select value={docType} onChange={e => setDocType(e.target.value)} disabled={state === "submitting"}
                ...
                {CORPORATE_DOC_TYPES.map(t => <option key={t.value} value={t.value} className="bg-[#ede8f5]">{t.label}</option>)}
              </select>
            </div>
            <div>
